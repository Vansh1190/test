...
const SingleBlog = ({ blog }: { blog: Blog }) => {
  ...
  return (
    <>
      <div
        className="wow fadeInUp hover:shadow-two dark:hover:shadow-gray-dark group relative bg-white shadow-one duration-300 bg-[#e5e7eb] rounded-[15px]"
        data-wow-delay=".1s"
      >
        <Link
          href="/blog-details"
        ...
        >
          ...
          <Image className = 'p-4 rounded-[29px]'  src={image} alt="image" fill />
        </Link>
